...
export default function CardComments(){
    return (
        <>
        <div class="flex flex-col justify-between rounded-lg shadow-sm dark:bg-gray-800">
            <figure class="flex flex-col items-center justify-center p-14 text-center bg-white rounded-xl">
