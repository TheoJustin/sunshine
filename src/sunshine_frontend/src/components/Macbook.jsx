        ...
        >
          <div className="absolute inset-0 bg-[#272729] rounded-lg overflow-hidden">
            <img 
              src={src || ""} 
              alt="motoko logo" 
              style={{ objectFit: 'fill' }} // This ensures the image will fill the entire container
              className="w-full h-full" // Ensure width and height are 100%
            />
          </div>
        </motion.div>
      </div>
...
const BaseArea = ({ showGradient, badge }) => (
    ...
    <div className="flex relative">
        <div className="mx-auto w-[10%] overflow-hidden h-full">
            <SpeakerGrid /> {/* Correct invocation of the SpeakerGrid component */}
        </div>
        ...
        <div className="mx-auto w-[10%] overflow-hidden h-full">
            <SpeakerGrid /> {/* Ensure repeated components are also invoked correctly */}
        </div>
    </div>
    <Trackpad />
